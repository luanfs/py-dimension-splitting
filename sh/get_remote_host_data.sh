...
output_dir_remote_host2="/home/luansantos/doc/opsplit/"              #remote host data directory (remote_host2)
output_dir_local_host="/home/luan/doc/code/py-dimension-splitting/"  #local data directory
data='graphs'           #name of directory where data is in output_dir_remote_host2
output='dsplit_data'   #output file (.tar)
